            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 8px;">
                    <select onchange="if(this.value !== '') { document.getElementById('course_type_input').value = this.value; }" style="padding: 12px; border: 1px solid var(--border); border-radius: 8px; width: 40%; background: #ffffff; outline: none;">
                        ...
                        <option value="Programming" <?= $course['course_type'] == 'Programming' ? 'selected' : '' ?>>Programming</option>
                        <option value="Game Design" <?= $course['course_type'] == 'Game Design' ? 'selected' : '' ?>>Game Design</option>
                        <option value="AI & Robotics" <?= $course['course_type'] == 'AI & Robotics' ? 'selected' : '' ?>>AI & Robotics</option>
                        <option value="Web Dev" <?= $course['course_type'] == 'Web Dev' ? 'selected' : '' ?>>Web Dev</option>
                    </select>
                    <input type="text" name="course_type" id="course_type_input" value="<?= esc($course['course_type'] ?? '') ?>" placeholder="Or enter manual track name" required style="width: 60%; padding: 12px; border: 1px solid var(--border); border-radius: 8px; outline: none;">
                </div>
            </div>
            <div class="form-group">
