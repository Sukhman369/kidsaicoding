...
<div class="card" style="max-width: 800px; padding: 28px; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.02); background: #fff; border: 1px solid var(--border);">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px; border-bottom: 1px solid var(--border); padding-bottom: 16px;">
        <h3 style="color: var(--text-main); font-weight: 700; margin: 0;">
            <i class="fa-solid fa-person-circle-plus" style="color: var(--primary); margin-right: 8px;"></i> Add Team Member
        </h3>
    ...
    <form action="<?= base_url('admin/team/store') ?>" method="POST" enctype="multipart/form-data">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 24px;">
            <div class="form-group">
                ...
                <input type="text" name="name" required placeholder="e.g. Dr. Gaurav Sharma" style="width: 100%; padding: 12px; border: 1px solid var(--border); border-radius: 8px; outline: none; font-size: 0.9rem;">
            </div>

            <div class="form-group">
                <label style="display: block; margin-bottom: 8px; font-weight: 600; font-size: 0.9rem; color: var(--text-main);">Role Title</label>
                <input type="text" name="role" required placeholder="e.g. Lead Robotics Instructor" style="width: 100%; padding: 12px; border: 1px solid var(--border); border-radius: 8px; outline: none; font-size: 0.9rem;">
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 24px;">
            <div class="form-group">
                ...
                <input type="file" name="image" accept="image/webp" required style="width: 100%; padding: 10px; border: 1px dashed var(--border); border-radius: 8px; background: #fafafa; outline: none;">
                <p style="font-size: 0.72rem; color: var(--text-muted); margin-top: 4px;"><b>Mandatory: WEBP format (.webp) only.</b> Recommended Solution: 300x300px (1:1 aspect ratio). Max Size: 2MB.</p>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="order_index" value="0" style="width: 100%; padding: 12px; border: 1px solid var(--border); border-radius: 8px; outline: none; font-size: 0.9rem;">
        ...
        <div class="form-group" style="margin-bottom: 28px;">
            ...
            <textarea name="bio" rows="5" required placeholder="Describe experience, teaching credentials, and technology focus..." style="width: 100%; padding: 12px; border: 1px solid var(--border); border-radius: 8px; outline: none; resize: vertical; font-size: 0.9rem; line-height: 1.5;"></textarea>
        </div>
        ...
        <div style="display: flex; gap: 12px; border-top: 1px solid var(--border); padding-top: 20px;">
            <button type="submit" class="btn btn-primary" style="padding: 12px 30px; font-weight: 700; border-radius: 8px;">
                <i class="fa-solid fa-save" style="margin-right: 6px;"></i> Save Team Member
            </button>
