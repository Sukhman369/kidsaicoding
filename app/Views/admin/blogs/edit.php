...
<form action="<?= base_url('admin/blogs/update/'.$blog['id']) ?>" method="POST" enctype="multipart/form-data">
        ...
        <div>
            <div class="editor-tabs">
                <button type="button" class="editor-tab-btn active" id="writeTabBtn">
                    <i class="fa-solid fa-pen-nib"></i> Edit Article
                </button>
    ...
    <div class="blog-editor-container">
            ...
            <div class="editor-card">
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <input type="text" name="title" id="blogTitleInput" class="form-input form-input-title" required 
                           placeholder="e.g. 5 Coding Games That Teach Kids Python in 2026" autocomplete="off" value="<?= esc($blog['title']) ?>">
                    <div class="stats-row">
            ...
            <div class="editor-card">
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <textarea name="content" id="blogContentInput" class="form-textarea textarea-with-toolbar" rows="18" required 
                              placeholder="Write your beautiful article content here. You can use markdown or plain HTML headings, paragraphs, and links..." style="line-height: 1.75; font-size: 1rem; resize: vertical;"><?= esc($blog['content']) ?></textarea>
                    <div class="stats-row">
        ...
        <div id="sidebarSection">
            ...
            <div class="editor-card">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <div style="display: flex; align-items: center; gap: 10px; background: #eef2f6; padding: 10px 14px; border-radius: 8px;">
                        <img src="https://ui-avatars.com/api/?name=<?= urlencode($blog['author']) ?>&background=4f46e5&color=fff" 
            ...
            <div class="editor-card">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    <?php 
                        $hasImage = !empty($blog['image_path']) && file_exists(FCPATH . $blog['image_path']); 
                        $imgUrl = $hasImage ? base_url($blog['image_path']) : '#';
                    ?>
                    <div class="image-upload-wrapper" id="uploadWrapper">
                        <div id="dropzoneText" style="<?= $hasImage ? 'display: none;' : '' ?>">
                        ...
                        <div class="preview-container" id="previewContainer" style="<?= $hasImage ? 'display: block;' : '' ?>">
                            <button type="button" class="remove-image-btn" id="removeImageBtn" title="Remove Cover Image">
                                <i class="fa-solid fa-xmark"></i>
                            </button>
                            <img src="<?= $imgUrl ?>" alt="Preview" class="preview-image" id="previewImg">
                        </div>
                    </div>
                    <?php if ($hasImage): ?>
                        <p style="font-size: 0.72rem; color: var(--text-muted); margin-top: 8px;">Leave image blank to keep current cover banner.</p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="editor-card">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <textarea name="excerpt" id="blogExcerptInput" rows="3" class="form-textarea" 
                              placeholder="Describe the article in one or two sentences. This snippet will show up on Google search results and blog index cards..." style="font-size: 0.88rem; line-height: 1.5; resize: vertical;"><?= esc($blog['excerpt'] ?? '') ?></textarea>
                    <div class="stats-row">
    ...
    <div id="previewSection" class="live-preview-box" style="display: none; max-width: 850px; margin: 0 auto 50px auto;">
        ...
        <img src="<?= $imgUrl ?>" alt="Blog Banner Preview" class="blog-preview-banner" id="prevBanner" style="<?= $hasImage ? 'display: block;' : '' ?>">
        ...
        <div class="blog-preview-header">
            ...
            <div class="blog-preview-meta">
                <div class="blog-preview-meta-item">
                    ...
                    <span>By <strong style="color: var(--text-main);"><?= esc($blog['author']) ?></strong></span>
                </div>
                <div class="blog-preview-meta-item">
    ...
    if (imageInput && uploadWrapper) {
        ...
        if (removeImageBtn) {
            removeImageBtn.addEventListener('click', function(e) {
                ...
                // For edit preview, since they want to clean it or not upload a new one
                // we clear preview wrapper element styling
                <?php if ($hasImage): ?>
                    // if editing and there's a stored image on the server, we let them know it won't delete until they submit another or delete post
