            ...
            <div class="row g-4 mb-5 pb-5 border-bottom border-secondary border-opacity-25">
                ...
                <div class="col-lg-2 offset-lg-1 col-6">
                    ...
                    <ul class="list-unstyled d-grid gap-2 small">
                        ...
                        <li><a href="<?= base_url('about') ?>" class="text-white-50 text-decoration-none">Curriculum</a></li>
                        <li><a href="<?= base_url('contact') ?>" class="text-white-50 text-decoration-none">Contact Us</a></li>
                    </ul>
                </div>
